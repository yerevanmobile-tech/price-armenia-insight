  ...
  head: () => ({
    meta: [
      ...
      { title: "Price Monitor — Մրցակիցների գների մոնիթորինգ" },
      {
        name: "description",
        content:
          "Price Monitor — B2B մոբայլ հավելված հայկական էլեկտրոնիկայի խանութների համար՝ մրցակիցների գների հսկման համար։",
      },
      { property: "og:title", content: "Price Monitor" },
      { property: "og:description", content: "Competitor price monitoring for Armenian electronics retailers." },
